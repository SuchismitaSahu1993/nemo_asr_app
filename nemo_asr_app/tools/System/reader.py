...
class Reader(CommonReader):
  ...
  def new(project_id):
    ...
    manifest.am.train_params.lr_policy = None
    manifest.am.train_params.warmup_steps = None
    manifest.am.train_params.warmup_ratio = None
    manifest.am.train_params.weight_decay = None
    manifest.am.train_params.model_config = None
    manifest.am.train_params.optimizer = None
    manifest.am.train_params.amp_opt_level = 'O1'
    manifest.am.train_params.beta1 = None
    manifest.am.train_params.beta2 = None
    manifest.am.train_params.pretrained_encoder = os.path.join(cfg.NEMO.PRETRAINED,'JasperEncoder-STEP-247400.pt')
    manifest.am.train_params.pretrained_decoder = os.path.join(cfg.NEMO.PRETRAINED,'JasperDecoderForCTC-STEP-247400.pt')
    manifest.am.train_params.wandb_key = None  # wandb
    manifest.am.train_params.update_freq = None  # wandb
    manifest.am.train_params.eval_freq = None  # wandb
    manifest.am.train_params.project = None  # wandb
    manifest.am.train_params.exp_name = None  # wandb
  ...
  def remove_decoder(self):
    self.manifest.am.train_params.pretrained_decoder = None
    print("Decoder removed - pretrained_decoder set to: {}".format(self.manifest.am.train_params.pretrained_decoder))
    self.save_manifest()
  ...
  def _construct_name(self, name=''):
    ...
    #                          model_folder)
    model_path = self.manifest.am.train_params.work_dir
