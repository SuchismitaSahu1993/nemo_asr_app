...
def create_all_dags(args, neural_factory):
    ...
    if args.pretrained_encoder:
        ...
        jasper_encoder.restore_from(args.pretrained_encoder)
        logging.info("Loaded encoder: {}".format(args.pretrained_encoder))
        if args.pretrained_decoder != "":
          jasper_decoder.restore_from(args.pretrained_decoder)
          logging.info("Loaded pretrained decoder: {}".format(args.pretrained_decoder))
